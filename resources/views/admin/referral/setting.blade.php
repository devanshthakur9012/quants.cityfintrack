        ...
        <div class="col-lg-4 mb-4">
            <div class="card border--primary parent">
                <div class="card-header bg--primary">
                    <h5 class="text-white float-start">@lang('Deposit Commission')</h5>
                    @if (@$general->deposit_commission == 0)
                        <a href="{{ route('admin.referral.setting.status') }}" class="btn btn--success btn-sm float-end"><i
                                class="las la-toggle-on"></i> @lang('Enable Now')</a>
                    @else
                        <a href="{{ route('admin.referral.setting.status') }}" class="btn btn--danger btn-sm float-end"><i
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.referral.setting.update') }}" method="post" class="d-none levelForm">
                        @csrf
