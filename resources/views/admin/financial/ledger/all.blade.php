...
<div class="row">
    <div class="col-lg-12">
        <form action="{{route('admin.financial-overview.ledger.remove-stock-portfolio')}}" name="record_frm" id="record_frm" method="post">
            @csrf
                <div class="card responsive-filter-card mb-4">
                    <div class="card-body">
                        <div class="d-flex flex-wrap gap-3">
                            ...
                            <div class="flex-grow-1 align-self-end">
                                <a class="btn btn--primary w-100 h-45" href="{{url('admin/financial-overview/ledger')}}"><i class="las la-sync-alt"></i> Refresh</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table table--light style--two">
                        ...
                        <tbody>
                            @forelse($ledgers as $ledger)
                                <tr>
                                    <td>
                                        <input type="checkbox" name="data[]" value="{{$ledger->id}}" class="checkAll">
                                    </td>
                                    <td>
                                    ...
                                    <td>{{ showDate($ledger->bought_date) }}</td>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-end flex-wrap gap-2">
                                            ...
                                            <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                ...
                                                data-action="{{ route('admin.financial-overview.ledger.delete') }}"
...
<script>
    $("#client_id").select2({
        ...
        ajax: {
            url: "{{ route('admin.financial-overview.ledger.get-search-client-id') }}",
            dataType: "json",
            type: "GET",
    ...
    $("#stock_name").select2({
        ...
        minimumResultsForSearch: 10,
        ajax: {
            url: "{{ route('admin.financial-overview.ledger.get-stock-name') }}",
            dataType: "json",
            type: "GET",
            data: function(params) {
...
<script>
    $("#filter_btn").on('click',function(){
        ...
        window.location.href = '{{url("admin/financial-overview/ledger")}}?client_id='+client_id+"&stock_name="+stock_name+"&buy_date="+buy_date;
    });
</script>
