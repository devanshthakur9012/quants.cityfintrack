{{-- FILE: resources/views/admin/analysis-config/index.blade.php --}}
                    ...
                    <table class="table table--light style--two">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{-- Always 15min — shown as badge, never a dropdown --}}
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 d-flex align-items-center">
                            <div class="alert alert-info p-2 mb-0 w-100 mt-3" style="font-size:13px;">
                                <i class="las la-info-circle"></i>
                                Timeframe is <strong>15min (fixed)</strong>.
                                30min / 1hr will be derived from this data later.
                            </div>
                        </div>
                        <div class="col-md-12 mt-2">
                            <div class="form-group">
                                ...
                                <input type="text" id="addSymbolSearch"
                                       class="form-control form-control-sm mb-2"
                                       placeholder="Search symbols...">
                                <div class="symbol-checkbox-list border rounded p-2"
                                     style="max-height:260px; overflow-y:auto;">
                                    @foreach($symbols as $sym)
                                    <div class="form-check symbol-item">
                                        <input class="form-check-input add-symbol-check"
                                               type="checkbox"
                                               name="symbol_ids[]"
                                               value="{{ $sym->id }}"
                                               id="add_sym_{{ $sym->id }}">
                                ...
                                <small class="text-muted">
                                    Selected: <span id="addSelectedCount">0</span> / 50
                                </small>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>@lang('Broker') <sup class="text--danger">*</sup></label>
                                <select name="broker_api_id" id="edit_broker_api_id"
                        ...
                        <div class="col-md-12 mt-2">
                            <div class="form-group">
                                ...
                                <input type="text" id="editSymbolSearch"
                                       class="form-control form-control-sm mb-2"
                                       placeholder="Search symbols...">
                                <div class="symbol-checkbox-list border rounded p-2"
                                     style="max-height:260px; overflow-y:auto;">
                                    @foreach($symbols as $sym)
                                    <div class="form-check symbol-item">
                                        <input class="form-check-input edit-symbol-check"
                                               type="checkbox"
                                               name="symbol_ids[]"
                                               value="{{ $sym->id }}"
                                               id="edit_sym_{{ $sym->id }}">
                                ...
                                <small class="text-muted">
                                    Selected: <span id="editSelectedCount">0</span> / 50
                                </small>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p class="text--danger">
                    ...
                    @lang('This will permanently delete this config and all symbol associations. This action cannot be undone.')
                </p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn--dark btn-sm"
...
$(document).ready(function () {
    ...
    $(document).on('click', '.edit-config-btn', function () {
        ...
        const symbolIds = btn.data('symbol_ids');
        const url       = "{{ route('admin.analysis-config.update', ':id') }}"
                            .replace(':id', id);

        $('#editConfigForm').attr('action', url);
        $('#edit_broker_api_id').val(brokerId);

        // Restore symbol checkboxes
    ...
    $(document).on('click', '.delete-config-btn', function () {
        ...
        const url    = "{{ route('admin.analysis-config.destroy', ':id') }}"
                         .replace(':id', id);

        $('#deleteConfigLabel').text(broker + ' / 15MIN');
