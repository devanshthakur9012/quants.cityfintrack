            ...
            <div class="card-body">
                <form action="{{ route('admin.setting.notification.global.update') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>@lang('Telegram Body') </label>
                                <textarea class="form-control" rows="4" placeholder="@lang('Telegram Body')" name="telegram_template" required>{{ $general->telegram_template }}</textarea>
                            </div>
                        </div>
                    </div>
