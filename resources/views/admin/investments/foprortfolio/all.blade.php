...
<div class="row">
    <div class="col-lg-12">
        <form action="{{route('admin.investment.fo-portfolio-hedging.remove-foPortfolio')}}" name="record_frm" id="record_frm"     method="post">
            @csrf
            <div class="card responsive-filter-card mb-4">
                <div class="card-body">
                    <div class="d-flex flex-wrap gap-3">
                        ...
                        <div class="flex-grow-1 align-self-end">
                            <a class="btn btn--primary w-100 h-45" href="{{url('admin/investment/fo-portfolio-hedging')}}"><i class="las la-sync-alt"></i> Refresh</a>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-end flex-wrap gap-2">
                                            ...
                                            <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                ...
                                                data-action="{{ route('admin.investment.fo-portfolio-hedging.delete') }}"
...
<script>
    $("#client_id").select2({
        ...
        ajax: {
            url: "{{ route('admin.investment.fo-portfolio-hedging.get-faport-search-client-id') }}",
            dataType: "json",
            type: "GET",
    ...
    $("#stock_name").select2({
        ...
        minimumResultsForSearch: 10,
        ajax: {
            url: "{{ route('admin.investment.fo-portfolio-hedging.get-foport-name') }}",
            dataType: "json",
            type: "GET",
            data: function(params) {
...
<script>
    $("#filter_btn").on('click',function(){
        ...
        window.location.href = '{{url("admin/investment/fo-portfolio-hedging")}}?client_id='+client_id+"&stock_name="+stock_name+"&buy_date="+buy_date;
    });
</script>
