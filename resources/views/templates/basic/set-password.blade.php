...
<div class="ql-card">
    ...
    <div class="ql-left">
        ...
        <h1 class="ql-heading">Set Password</h1>

        <p style="font-size:14px; color:#666; margin-bottom:24px;">
            Welcome, <strong>{{ $user->firstname }}</strong>! Set a strong password to secure your account.
        </p>
        ...
        <form method="POST" action="{{ route('user.set.password') }}">
            ...
            <button type="submit" class="ql-cta-btn">
                <i class="fas fa-lock"></i> Set Password &amp; Login
            </button>
        </form>
