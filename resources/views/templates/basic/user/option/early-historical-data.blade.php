...
<section class="pt-50 pb-50">
    <div class="container content-container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            {{-- <a href="{{ route('user.manually.historical.options') }}" class="btn btn-primary">Run Manually</a> --}}
        </div>
        <!-- Filters -->
        ...
        <div class="custom--card card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <span class="fw-bold">Historical Options Data</span>
...
$(document).ready(function() {
    ...
    function fetchHistoricalData() {
        ...
        $.post("{{ route('user.early.historical.options.fetch') }}", filters, function(response) {
            // Update table
