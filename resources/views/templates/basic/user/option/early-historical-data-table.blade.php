        ...
        <tbody>
            @forelse($data as $row)
                <tr>
                    ...
                    @php
                        $futPrice = $row->future_oi/1000000;
                    @endphp
                    <td>{{ $futPrice ? number_format($futPrice,2) : '-' }}</td>
                    <td>
                    ...
                    @php
                        $cePrice = $row->ce_oi/1000000;
                    @endphp
                    <td>{{ $cePrice ? number_format($cePrice,2) : '-' }}</td>
                    <td>
                    ...
                    @php
                        $pePrice = $row->pe_oi/1000000;
                    @endphp
                    <td>{{ $pePrice ? number_format($pePrice,2) : '-' }}</td>
                    <td>
