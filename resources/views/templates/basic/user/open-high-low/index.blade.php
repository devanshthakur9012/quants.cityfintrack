...
.ohl-hero-left h1 span { color:#7DFF00; }
...
.ohl-inst-tab:hover { border-color:#7DFF00; color:#c97f00; }
.ohl-inst-tab.on-stock  { border-color:#059669; background:rgba(5,150,105,.08); color:#047857; }
.ohl-inst-tab.on-fut    { border-color:#7DFF00; background:rgba(245,166,35,.08); color:#c97f00; }
...
.ohl-sym-select:focus { border-color:#7DFF00; }
...
.ohl-date-input:focus { border-color:#7DFF00; }
.ohl-date-nav {
...
.ohl-date-nav:hover { border-color:#7DFF00; color:#7DFF00; }
...
.ohl-tol-input:focus { border-color:#7DFF00; }
...
.ohl-reset-btn:hover { border-color:#7DFF00; color:#c97f00; }
...
.c-date  { font-size:11px; color:#7DFF00; font-weight:700; }
