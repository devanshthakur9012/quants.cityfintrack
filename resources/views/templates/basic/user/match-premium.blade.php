    ...
    <div class="container-fluid mb-1">
        <div class="custom--nav-tabs border-0 mb-3">
            <ul class="nav d-flex justify-content-start">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{ url('/user/match-premium') }}">PREMIUM</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('/user/match-theta') }}">THETA</a>
                </li>
            </ul>
        </div>
    </div>
...
<script>
    $(document).ready(function(){
        function reloadData(){
            ...
            $.get('{!!url("user/match-premium-ajax?".(isset($_SERVER["QUERY_STRING"]) ? $_SERVER["QUERY_STRING"] : ''))!!}',function(data){
                // console.log(data);
                $("#pst_hre").html(data);
            });
        }
