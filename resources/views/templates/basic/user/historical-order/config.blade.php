    ...
    <div class="container content-container">
        <div class="text-end">
            <button class="btn btn--base" type="button" data-bs-toggle="modal" data-bs-target="#masterConfigModal">
                <i class="las la-plus"></i> @lang('Add Configuration')
            </button>
        </div>
        <div class="row mt-3">
            <div class="col-lg-12">
                <div class="custom--card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Order Historical Master</h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge badge--dark">
                                                    {{ $master->historicalPortfolio()->count() }} symbols
                                                </span>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="{{ route('user.oms-historical-order',['id'=>$master->id]) }}" class="btn btn-sm btn-primary" target="_blank"
                                                            title="View Symbols">
...
<div class="modal fade" id="masterConfigModal" tabindex="-1" aria-labelledby="masterConfigModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="{{ route('user.oms-historical-store') }}" class="transparent-form" method="post">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 form-group">
                            ...
                            <input type="date" name="order_date" placeholder="Order Date" id="order_date" class="form--control">
                        </div>
...
$(document).ready(function() {
    ...
    $('.delete-master').on('click', function() {
        const masterId = $(this).data('id');
        const deleteUrl = "{{ route('user.oms-historical-master-destroy', ':id') }}".replace(':id', masterId);
