    ...
    <div class="container-fluid content-container">
        ...
        <div class="page-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h4>{{ $pageTitle }} <span class="new-logic-badge">NEW LOGIC</span></h4>
                    <p>Price Movement + OI Change Analysis</p>
                </div>
                <div>
        ...
        <div class="alert" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; border: none; border-radius: 12px; margin-bottom: 25px;">
            <h6 style="color: white; margin-bottom: 10px;"><i class="fas fa-info-circle"></i> <strong>Trading Logic:</strong></h6>
            <div class="row">
                <div class="col-md-6">
                ...
                <table class="table custom--table">
                    <thead>
                        <tr>
                            ...
                            <th>Symbol</th>
                            <th>FUT Symbol</th>
                            <th>Price Movement <span class="new-logic-badge">NEW</span></th>
                            <th>OI Change <span class="new-logic-badge">NEW</span></th>
                            <th>Signal <span class="new-logic-badge">NEW</span></th>
                            <th>Reason</th>
                            <th>Order Picked</th>
                        </tr>
                    </thead>
        ...
        analysisData.forEach(function (row, index) {
            ...
            html += `
                <tr>
                    ...
                    <!-- Price Movement -->
                    <td class="data-cell">
                        <div class="${priceClass}" style="font-size: 0.9rem;">
                            ${priceIcon} ₹${Math.abs(row.price_change)} (${row.price_change_percent}%)
                        </div>
                        <small class="text-muted" style="font-size: 0.75rem;">
                            Open: ₹${row.open_price} → ₹${row.current_price}
                        </small>
                    </td>
