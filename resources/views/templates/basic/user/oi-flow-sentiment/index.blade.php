            ...
            <table class="ofs-table">
                <thead>
                    <tr class="th-group">
                        ...
                        <th colspan="6" class="g-signal sep-signal">Signal</th>
                    </tr>
                    <tr class="th-cols">
                        ...
                        <th>PE Chg %</th>
                        <th class="sep-signal">Sentiment</th><th>Condition</th><th>OI Confirm</th><th>Prev Trend</th><th>Strength</th><th>Action</th>
                    </tr>
                </thead>
                <tbody id="ofs-tbody">
                    <tr><td colspan="15"><div class="ofs-spinner-row"><div class="ofs-spinner"></div>Detecting last available date…</div></td></tr>
                </tbody>
            </table>
        </div>
    </div>
