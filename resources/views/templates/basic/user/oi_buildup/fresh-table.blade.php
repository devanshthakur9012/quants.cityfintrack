<table class="custom--table table mb-0">
    <thead>
        <tr>
            ...
            <th style="padding:10px !important;">Avg OI Change %</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            {{-- ✅ Show average OI Change % --}}
            <td>
                {{ isset($symbolWiseAvgOiChangePercent[$row->symbol]) 
                    ? $symbolWiseAvgOiChangePercent[$row->symbol] . '%' 
                    : '0%' }}
            </td>
