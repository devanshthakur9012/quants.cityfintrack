...
<section class="pt-50 pb-50">
    <div class="container content-container">
        ...
        <div class="mb-3 d-flex align-items-center">
            <label class="me-2 fw-bold">Symbol:</label>
            <select id="symbolFilter" class="form-select w-auto">
...
<script>
    ...
    function fetchOiData(type) {
        ...
        $.post("{{ route('user.oi.buildup-fresh.fetch') }}", {
            _token: '{{ csrf_token() }}',
            type: type,
            symbol: symbol
        }, function (res) {
    ...
    $('#symbolFilter').on('change', function () {
        const selectedType = $('.nav-link.active').data('type') || 'all';
