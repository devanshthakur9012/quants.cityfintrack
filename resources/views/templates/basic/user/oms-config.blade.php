        ...
        <form action="{{route('user.portfolio.store-oms-config')}}" class="transparent-form" method="post">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-lg-6 form-group">
                        <label for="strategy_name" class="required">Select Buildup Type<sup class="text--danger">*</sup></label>
                        <select name="strategy_name" class="form--control" required="" id="strategy_name">
                    ...
                    <div class="col-lg-6 form-group">
                        ...
                        <input type="number" max="100" min="0" class="form--control" required="" id="dis_ltp">
                    </div>
