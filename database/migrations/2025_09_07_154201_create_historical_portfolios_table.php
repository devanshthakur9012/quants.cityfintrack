...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('historical_portfolios', function (Blueprint $table) {
            $table->id();
            
            // Add config_id column first
            $table->foreignId('config_id')
                ->constrained('historical_orders')
                ->onDelete('cascade');
            ...
            $table->unique(['config_id', 'symbol_name', 'token'], 'unique_symbol_per_config');
        });
    }
    ...
    {
        Schema::dropIfExists('historical_portfolios');
    }
};
