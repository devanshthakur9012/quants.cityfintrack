...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('oms_config_masters', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['portfolio_type', 'buildup_type', 'broker_api_id', 'user_id'], 'unique_master_config');
        });
    }
    ...
    {
        Schema::dropIfExists('oms_config_masters');
    }
};
