...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('fut_contrarian_configs', function (Blueprint $table) {
            ...
            // Window mode is controlled by trade_30min + trade_1hr booleans:
            //   30min only → trade_30min=1, trade_1hr=0  → FUT + 30min OI → buy 10:00
            //   1hr only   → trade_30min=0, trade_1hr=1  → FUT + 1hr OI  → buy 10:30
            //   Both req'd → trade_30min=1, trade_1hr=1  → all 3 must match
