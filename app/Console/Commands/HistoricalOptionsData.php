...
class HistoricalOptionsData extends Command
{
    use AngelApiAuth;

    protected $signature = 'options:historical-data {--date= : Specific date to process (Y-m-d format)}';
    ...
    private function fetchAllInstrumentData(OptionsChain $chain, string $date): array
    {
        return [
    ...
    private function fetchPreviousData(OptionsChain $chain): array
    {
        return [
    ...
    private function calculateChangesAndTrend(array $currentData, array $previousData): array
    {
        ...
        // dd($previous['future_price'], $current['future_price'],$current,$previous);
    ...
    private function insertHistoricalData(OptionsChain $chain, string $date, array $currentData, array $calculations): void
    {
        ...
        DB::table('historical_options_data')->insert($insertData);
    }
