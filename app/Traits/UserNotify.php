...
trait UserNotify
{
    public static function notifyToUser(){
        return [
            ...
            'withPackageUsers'      => 'With Package Users',
            'withoutPackageUsers'   => 'Without Package Users',
        ]; 
    }

    public function scopeWithPackageUsers($query){
        return $query->whereHas('package');
    }

    public function scopeWithoutPackageUsers($query){
        return $query->whereDoesntHave('package');
    }
